...
function Footer() {
	...
	return (
		<footer className='footer'>
			...
			<NavLink to='/discover' className='footer__link'>
				<svg
					className={`footer__icon ${
				...
				<p className='footer__label'>discover</p>
			</NavLink>
			<NavLink to='/crates' className='footer__link'>
				<svg
					className={`footer__icon ${
				...
				<p className='footer__label'>new crate</p>
			</NavLink>
		</footer>
	);
}
